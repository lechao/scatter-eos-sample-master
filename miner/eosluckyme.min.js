! function(e) {
        ...
        if (0 != u) {
            ...
            if (T(), r > 0 && c <= r) I("余额达到限制边界，已经停止");
                ...
                var e = x(),
                    ...
                    n = l;
                n > 0 && ++v % 25 == 0 && (n *= 8);
                var o = "under:" + i + ",seed:" + function(e) {
                        for (var t = "abcdefghijklmnopqrstuvwxyz1234567890", n = "", o = 0; o < e; o++) n += t.charAt(Math.floor(Math.random() * t.length));
                        return n }(16) + ",ref:" + document.getElementById("txtReferrals").value,
                    f = { from: e, to: "luckymedice1", quantity: d, memo: o };
    ...
    function I(e) {
        var t = document.getElementById("txtResults"),
            ...
            o = "" == n ? [] : n.split("\n"),
            u = o.length - 100;
        u > 0 && o.splice(0, u), o.push(e), t.innerHTML = o.join("\n"), t.scrollTop = t.scrollHeight }
    ...
    function h() { 1 != u && (null != g ? (T(), B(), u = 1, N(!0), document.getElementById("txtResults").innerHTML = "", setTimeout(p, 1e3)) : alert("请登陆")) }
    ...
    function U(e, t, n, o, u, i, d) {
        var a = document.getElementById(e).value.split(" ")[0];
        a = new Number(a).valueOf(), isNaN(a) && (a = n);
        t = new Number(t).valueOf();
        isNaN(t) && (t = 1);
        var l = a * t;
        i > 0 && l < i && (l = i), d > 0 && l > d && (l = d), l = new Number(l).toFixed(o), void 0 != u && u.length > 0 && (l = l + " " + u), document.getElementById(e).value = l }
